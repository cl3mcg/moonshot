...
router.get("/new", isLoggedIn, registerCtrl.renderNewPage);

// router.post("/new", isLoggedIn, validateRegister, async function (req, res) {
...
router.post("/new", isLoggedIn, validateRegister, registerCtrl.createRegister);

// router.get("/index", isLoggedIn, catchAsync(async function (req, res) {
//     const d = new Date();
...
// router.get("/history", isLoggedIn, catchAsync(async function (req, res) {
//   const d = new Date();
//   const today = new Date(d.getFullYear(), d.getMonth(), d.getDate());
//   const d14 = new Date(d.setDate(d.getDate() + 14));
//   const next14days = new Date(
...
router.get("/:id", isLoggedIn, registerCtrl.renderShowPage);

  // router.post("/:id/participation/:decision", isLoggedIn, validateDecision, catchAsync(async function (req, res) {
  //   let matchingId = req.params.id;
...
router.post("/:id/participation/:decision", isLoggedIn, validateDecision, registerCtrl.tenderTeamDecision);
  ...
  // router.get("/edit/:id", isLoggedIn, catchAsync(async function (req, res) {
  //     let matchingId = req.params.id;
...
router.get("/edit/:id", isLoggedIn, registerCtrl.renderEditPage);


  // router.patch("/edit/:id", isLoggedIn, validateRegister,catchAsync(async function (req, res) {
  //     let matchingId = req.params.id;
...
router.patch("/edit/:id", isLoggedIn, validateRegister, registerCtrl.patchRegister);
...
router.delete("/:id", isLoggedIn, registerCtrl.deleteRegister);
